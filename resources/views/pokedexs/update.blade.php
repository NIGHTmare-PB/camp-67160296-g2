...
@section('content')
    ...
    <form action="{{ url('/pokedexs/'.$pokedex_update->id) }}" method="post">
        ...
        <input class="form-control"type="text" name="hp" id="hp"  value="{{$pokedex_update->hp}}">
        <label for="attack">Attack</label>
        <input class="form-control"type="text" name="attack" id="attack" value="{{$pokedex_update->attack}}">
        <label for="defense">Defense</label>
        <input class="form-control"type="text" name="defense" id="defense" value="{{$pokedex_update->defense}}">
